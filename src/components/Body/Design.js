                            ...
                            <ul id="grid" className="clear">
                                ...
                                <li>
                                    <svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <polygon points="50 1 95 25 95 75 50 99 5 75 5 25" stroke="rgb(151,0,0)" strokeWidth="1" fill="url(#img)"/>
                                    </svg>
                                ...
                                <li>
                                    <svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <polygon points="50 1 95 25 95 75 50 99 5 75 5 25" stroke="rgb(151,0,0)" strokeWidth="1" fill="url(#img2)"/>
                                    </svg>
                                ...
                                <li>
                                    <svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <polygon points="50 1 95 25 95 75 50 99 5 75 5 25" stroke="rgb(151,0,0)" strokeWidth="1" fill="url(#img3)"/>
                                    </svg>
                                ...
                                <li>
                                    <svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <polygon points="50 1 95 25 95 75 50 99 5 75 5 25" stroke="rgb(151,0,0)" strokeWidth="1" fill="url(#img4)"/>
                                    </svg>
                                ...
                                <li>
                                    <svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <polygon points="50 1 95 25 95 75 50 99 5 75 5 25" stroke="rgb(151,0,0)" strokeWidth="1" fill="url(#img5)"/>
                                    </svg>
